...
const SignUp = () => {
    ...
    const validationSchema = Yup.object({
        ...
        password: Yup.string()
            ...
            .matches(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$/, 'Password must contain at least one letter and one digit')
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            const response = await axios.post('http://your-backend-api-url/api/signup', values);
